window.onload = () => { 
    ...
    $('.use-checkbox-top').change(function(){
        if($('.use-checkbox-top:checked').length === $('.use-checkbox-top').length) {
    ...
    $('.use-checkbox-bottom').change(function(){
        if($('.use-checkbox-bottom:checked').length === $('.use-checkbox-bottom').length) {
    ...
    $(window).scroll(function(){
        ...
        if(scrollBar >= locationTop - 500 && scrollBar <= introTop - 500) {
